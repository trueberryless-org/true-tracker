...
export const automationSettings: AutomationSettings[] = [
  {
    ...
    description:
      "Automatically stop all running sessions when a project gets archived.",
    toastActivate:
      "Sessions will now automatically be stopped when the project gets archived.",
    toastDeactivate:
  ...
  },
  {
    ...
    description:
      "Move task status to “Completed” when their project gets archived.",
    toastActivate:
  ...
  },
  {
    ...
    description:
      "Mark projects as “Completed” when no session has been started for 3 months.",
    toastActivate:
  ...
  },
  {
    ...
    description:
      "Mark tasks as “Completed” when no session has been started for one month.",
    toastActivate:
