...
export default function ProjectPage() {
  ...
  const gridColsClass = project.archivedAt
    ? "xl:grid-cols-5"
    : "xl:grid-cols-4";
    ...
    <div className="flex w-full flex-col">
      <main className="flex min-h-[calc(100vh-_theme(spacing.16))] flex-1 flex-col gap-4 bg-muted/40 p-4 md:gap-8 md:p-10">
        <div className="flex items-center gap-4 min-h-9">
          ...
          <Badge
            variant="outline"
            className="ml-auto sm:ml-0 py-2 max-xs:hidden bg-background"
          >
            <PriorityIconLabel
          ...
          <Badge
            variant="outline"
            className="ml-auto sm:ml-0 py-2 max-sm:hidden bg-background"
          >
            <StatusIconLabel
        ...
        <div className="grid gap-4 md:gap-8 lg:grid-cols-2 xl:grid-cols-3">
          <Card
            className="xl:col-span-2 row-span-3 max-lg:order-1"
          ...
          <Card x-chunk="dashboard-01-chunk-0">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {msToTime(getProjectDuration(project))}
              </div>
              <p className="text-xs text-muted-foreground">
                You could also say around{" "}
                {msToTimeDaysOrSecondsLong(getProjectDuration(project))}
              </p>
            </CardContent>
          </Card>
          <Card x-chunk="dashboard-01-chunk-0">
          ...
          <Card x-chunk="dashboard-01-chunk-0">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                ...
                {project.tasks.flatMap((task) => task.sessions).length !== 1 &&
                  "s"}
              </div>
              <p className="text-xs text-muted-foreground">
                {
