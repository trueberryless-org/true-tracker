        ...
        <div className="flex w-full flex-col">
            <main className="flex min-h-[calc(100vh-_theme(spacing.16))] flex-1 flex-col gap-4 bg-muted/40 p-4 md:gap-8 md:p-10">
                                                    ...
                                                    <div className="space-y-1">
                                                        ...
                                                        <div className="flex items-center pt-2">
                                                            <span className="text-xs text-muted-foreground">
                                                                ...
                                                                “Planned” to “In Progress”, when you start working on it
                ...
                <div className="flex items-center justify-end gap-2 md:hidden">
                    <DropdownMenu
                        open={otherActionsDropdownMobileIsOpen || archiveDialogMobileIsOpen || deleteDialogMobileIsOpen}
                    ...
                    >
                        ...
                        <DropdownMenuContent className="w-56">
                            <DropdownMenuItem>
                                <Dialog open={archiveDialogMobileIsOpen} onOpenChange={setArchiveDialogMobileIsOpen}>
