      ...
      <DrawerContent>
        <div className="mx-auto w-full max-w-sm">
          <DrawerHeader>
            ...
            <DrawerDescription>
              You&apos;re in currently experienting the entire application with
              a test user. We recommend exiting this test user and creating a
              new user or import existing data from a previous user in the Sign
              Up menu.
            </DrawerDescription>
          </DrawerHeader>
